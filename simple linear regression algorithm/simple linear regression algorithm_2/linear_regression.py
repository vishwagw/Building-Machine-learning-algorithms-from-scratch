...
# import dataset:
# insert the url for dataset first:
...
# building the linear regression model class:
...
# now model have been trained
# final prediction:
#Example usage
linear_reg = LinearRegression()
parameters, loss = linear_reg.train(training_input, training_output, 0.0001, 20)
